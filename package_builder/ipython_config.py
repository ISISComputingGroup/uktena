...
import os
import site
genie_startup = os.path.join(site.getsitepackages()[1], 'genie_python', 'genie_startup.py')
c.InteractiveShellApp.exec_files = [genie_startup]

## lines of code to run at IPython startup.
c.InteractiveShellApp.exec_lines = ["ip = get_ipython()",
    "ip.Completer.matchers.remove(ip.Completer.magic_matcher)",
    "ip.Completer.matchers.remove(ip.Completer.file_matcher)"]
...
#c.InteractiveShell.banner1 = "Python 3.6.3 [MSC v.1900 64 bit (AMD64)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 6.1.0 -- An enhanced Interactive Python. Type '?' for help.\n"
